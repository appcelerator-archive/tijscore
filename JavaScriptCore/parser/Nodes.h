...
namespace TI {
    ...
    public:
        ...
        virtual TiValue jsValue(BytecodeGenerator&) const = 0;
    private:
    ...
    private:
        ...
        virtual TiValue jsValue(BytecodeGenerator&) const OVERRIDE { return jsNull(); }
    };
    ...
    private:
        ...
        virtual TiValue jsValue(BytecodeGenerator&) const OVERRIDE { return jsBoolean(m_value); }
    ...
    private:
        ...
        virtual TiValue jsValue(BytecodeGenerator&) const OVERRIDE { return jsNumber(m_value); }
    ...
    private:
        ...
        virtual TiValue jsValue(BytecodeGenerator&) const OVERRIDE;

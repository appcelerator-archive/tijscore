...
TiValue callGetter(ExecState* exec, TiValue base, TiValue getterSetter)
{
...
void callSetter(ExecState* exec, TiValue base, TiValue getterSetter, TiValue value, ECMAMode ecmaMode)
{

...
static EncodedTiValue JSC_HOST_CALL dateProtoFuncGetDate(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncGetDay(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncGetFullYear(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncGetHours(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncGetMilliSeconds(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncGetMinutes(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncGetMonth(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncGetSeconds(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncGetTime(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncGetTimezoneOffset(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncGetUTCDate(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncGetUTCDay(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncGetUTCFullYear(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncGetUTCHours(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncGetUTCMilliseconds(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncGetUTCMinutes(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncGetUTCMonth(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncGetUTCSeconds(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncGetYear(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncSetDate(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncSetFullYear(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncSetHours(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncSetMilliSeconds(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncSetMinutes(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncSetMonth(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncSetSeconds(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncSetTime(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncSetUTCDate(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncSetUTCFullYear(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncSetUTCHours(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncSetUTCMilliseconds(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncSetUTCMinutes(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncSetUTCMonth(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncSetUTCSeconds(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncSetYear(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncToDateString(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncToGMTString(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncToLocaleDateString(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncToLocaleString(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncToLocaleTimeString(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncToString(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncToTimeString(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncToUTCString(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncToISOString(ExecState*);
static EncodedTiValue JSC_HOST_CALL dateProtoFuncToJSON(ExecState*);
...
static EncodedTiValue formateDateInstance(ExecState* exec, DateTimeFormat format, bool asUTCVariant)
{
    ...
    if (!gregorianDateTime)
        return TiValue::encode(jsNontrivialString(exec, String(ASCIILiteral("Invalid Date"))));

    return TiValue::encode(jsNontrivialString(exec, formatDateTime(*gregorianDateTime, format, asUTCVariant)));
}
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncToString(ExecState* exec)
{
    const bool asUTCVariant = false;
    return formateDateInstance(exec, DateTimeFormatDateAndTime, asUTCVariant);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncToUTCString(ExecState* exec)
{
    const bool asUTCVariant = true;
    return formateDateInstance(exec, DateTimeFormatDateAndTime, asUTCVariant);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncToISOString(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
    ...
    return TiValue::encode(jsNontrivialString(exec, String(buffer, charactersWritten)));
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncToDateString(ExecState* exec)
{
    const bool asUTCVariant = false;
    return formateDateInstance(exec, DateTimeFormatDate, asUTCVariant);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncToTimeString(ExecState* exec)
{
    const bool asUTCVariant = false;
    return formateDateInstance(exec, DateTimeFormatTime, asUTCVariant);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncToLocaleString(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncToLocaleDateString(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncToLocaleTimeString(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncGetTime(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncGetFullYear(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncGetUTCFullYear(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncToGMTString(ExecState* exec)
{
    const bool asUTCVariant = true;
    return formateDateInstance(exec, DateTimeFormatDateAndTime, asUTCVariant);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncGetMonth(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncGetUTCMonth(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncGetDate(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncGetUTCDate(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncGetDay(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncGetUTCDay(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncGetHours(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncGetUTCHours(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncGetMinutes(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncGetUTCMinutes(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncGetSeconds(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncGetUTCSeconds(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncGetMilliSeconds(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncGetUTCMilliseconds(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncGetTimezoneOffset(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncSetTime(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
static EncodedTiValue setNewValueFromTimeArgs(ExecState* exec, int numArgsToUse, bool inputIsUTC)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
    ...
    TiValue result = jsNumber(gregorianDateTimeToMS(vm, gregorianDateTime, ms, inputIsUTC));
    thisDateObj->setInternalValue(vm, result);
    return TiValue::encode(result);
}

static EncodedTiValue setNewValueFromDateArgs(ExecState* exec, int numArgsToUse, bool inputIsUTC)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
...
EncodedTiValue JSC_HOST_CALL dateProtoFuncSetMilliSeconds(ExecState* exec)
{
    const bool inputIsUTC = false;
    return setNewValueFromTimeArgs(exec, 1, inputIsUTC);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncSetUTCMilliseconds(ExecState* exec)
{
    const bool inputIsUTC = true;
    return setNewValueFromTimeArgs(exec, 1, inputIsUTC);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncSetSeconds(ExecState* exec)
{
    const bool inputIsUTC = false;
    return setNewValueFromTimeArgs(exec, 2, inputIsUTC);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncSetUTCSeconds(ExecState* exec)
{
    const bool inputIsUTC = true;
    return setNewValueFromTimeArgs(exec, 2, inputIsUTC);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncSetMinutes(ExecState* exec)
{
    const bool inputIsUTC = false;
    return setNewValueFromTimeArgs(exec, 3, inputIsUTC);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncSetUTCMinutes(ExecState* exec)
{
    const bool inputIsUTC = true;
    return setNewValueFromTimeArgs(exec, 3, inputIsUTC);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncSetHours(ExecState* exec)
{
    const bool inputIsUTC = false;
    return setNewValueFromTimeArgs(exec, 4, inputIsUTC);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncSetUTCHours(ExecState* exec)
{
    const bool inputIsUTC = true;
    return setNewValueFromTimeArgs(exec, 4, inputIsUTC);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncSetDate(ExecState* exec)
{
    const bool inputIsUTC = false;
    return setNewValueFromDateArgs(exec, 1, inputIsUTC);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncSetUTCDate(ExecState* exec)
{
    const bool inputIsUTC = true;
    return setNewValueFromDateArgs(exec, 1, inputIsUTC);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncSetMonth(ExecState* exec)
{
    const bool inputIsUTC = false;
    return setNewValueFromDateArgs(exec, 2, inputIsUTC);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncSetUTCMonth(ExecState* exec)
{
    const bool inputIsUTC = true;
    return setNewValueFromDateArgs(exec, 2, inputIsUTC);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncSetFullYear(ExecState* exec)
{
    const bool inputIsUTC = false;
    return setNewValueFromDateArgs(exec, 3, inputIsUTC);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncSetUTCFullYear(ExecState* exec)
{
    const bool inputIsUTC = true;
    return setNewValueFromDateArgs(exec, 3, inputIsUTC);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncSetYear(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
    ...
    TiValue result = jsNumber(gregorianDateTimeToMS(vm, gregorianDateTime, ms, false));
    thisDateObj->setInternalValue(vm, result);
    return TiValue::encode(result);
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncGetYear(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    if (!thisValue.inherits(DateInstance::info()))
        return throwVMTypeError(exec);
    ...
    return TiValue::encode(jsNumber(gregorianDateTime->year() - 1900));
}

EncodedTiValue JSC_HOST_CALL dateProtoFuncToJSON(ExecState* exec)
{
    TiValue thisValue = exec->hostThisValue();
    ...
    TiValue toISOValue = object->get(exec, exec->vm().propertyNames->toISOString);
    if (exec->hadException())
        return TiValue::encode(jsNull());

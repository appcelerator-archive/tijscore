...
static EncodedTiValue JSC_HOST_CALL mathProtoFuncAbs(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncACos(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncACosh(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncASin(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncASinh(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncATan(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncATanh(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncATan2(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncCbrt(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncCeil(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncCos(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncCosh(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncExp(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncExpm1(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncFloor(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncFround(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncLog(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncLog1p(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncLog10(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncLog2(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncMax(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncMin(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncPow(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncRandom(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncRound(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncSin(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncSinh(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncSqrt(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncTan(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncTanh(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncTrunc(ExecState*);
static EncodedTiValue JSC_HOST_CALL mathProtoFuncIMul(ExecState*);
...
EncodedTiValue JSC_HOST_CALL mathProtoFuncAbs(ExecState* exec)
{
    return TiValue::encode(jsNumber(fabs(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncACos(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(acos(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncASin(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(asin(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncATan(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(atan(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncATan2(ExecState* exec)
{
...
EncodedTiValue JSC_HOST_CALL mathProtoFuncCeil(ExecState* exec)
{
    return TiValue::encode(jsNumber(ceil(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncCos(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(cos(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncExp(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(exp(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncFloor(ExecState* exec)
{
    return TiValue::encode(jsNumber(floor(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncLog(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(log(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncMax(ExecState* exec)
{
...
EncodedTiValue JSC_HOST_CALL mathProtoFuncMin(ExecState* exec)
{
    unsigned argsCount = exec->argumentCount();
    double result = +std::numeric_limits<double>::infinity();
    for (unsigned k = 0; k < argsCount; ++k) {
...
EncodedTiValue JSC_HOST_CALL mathProtoFuncPow(ExecState* exec)
{
    // ECMA 15.8.2.1.13
    ...
    if (std::isinf(arg2) && fabs(arg) == 1)
        return TiValue::encode(jsNaN());
    return TiValue::encode(jsNumber(mathPow(arg, arg2)));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncRandom(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(exec->lexicalGlobalObject()->weakRandomNumber()));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncRound(ExecState* exec)
{
    double arg = exec->argument(0).toNumber(exec);
...
EncodedTiValue JSC_HOST_CALL mathProtoFuncSin(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(sin(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncSqrt(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(sqrt(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncTan(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(tan(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncIMul(ExecState* exec)
{
...
EncodedTiValue JSC_HOST_CALL mathProtoFuncACosh(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(acosh(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncASinh(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(asinh(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncATanh(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(atanh(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncCbrt(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(cbrt(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncCosh(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(cosh(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncExpm1(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(expm1(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncFround(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(static_cast<float>(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncLog1p(ExecState* exec)
{
    double value = exec->argument(0).toNumber(exec);
    if (value == 0)
        return TiValue::encode(jsDoubleNumber(value));
    return TiValue::encode(jsDoubleNumber(log1p(value)));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncLog10(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(log10(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncLog2(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(log2(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncSinh(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(sinh(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncTanh(ExecState* exec)
{
    return TiValue::encode(jsDoubleNumber(tanh(exec->argument(0).toNumber(exec))));
}

EncodedTiValue JSC_HOST_CALL mathProtoFuncTrunc(ExecState*exec)
{
    return TiValue::encode(jsNumber(exec->argument(0).toIntegerPreserveNaN(exec)));
}

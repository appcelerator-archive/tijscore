...
namespace TI {
    ...
    private:
        ...
        static void put(JSCell* cell, ExecState* exec, PropertyName propertyName, TiValue v, PutPropertySlot& slot)
        {
        ...
        static void putByIndex(JSCell* cell, ExecState* exec, unsigned propertyName, TiValue v, bool shouldThrow)
        {
            RegExpMatchesArray* thisObject = jsCast<RegExpMatchesArray*>(cell);
            thisObject->reifyAllPropertiesIfNecessary(exec);

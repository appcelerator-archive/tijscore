...
void StringObject::put(JSCell* cell, ExecState* exec, PropertyName propertyName, TiValue value, PutPropertySlot& slot)
{
...
void StringObject::putByIndex(JSCell* cell, ExecState* exec, unsigned propertyName, TiValue value, bool shouldThrow)
{
    StringObject* thisObject = jsCast<StringObject*>(cell);
...
StringObject* constructString(VM& vm, JSGlobalObject* globalObject, TiValue string)
{

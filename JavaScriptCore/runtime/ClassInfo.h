...
struct MethodTable {
    ...
    typedef void (*PutFunctionPtr)(JSCell*, ExecState*, PropertyName propertyName, TiValue, PutPropertySlot&);
    PutFunctionPtr put;

    typedef void (*PutByIndexFunctionPtr)(JSCell*, ExecState*, unsigned propertyName, TiValue, bool shouldThrow);
    ...
    typedef TiValue (*ToThisFunctionPtr)(JSCell*, ExecState*, ECMAMode);
    ToThisFunctionPtr toThis;

    typedef TiValue (*DefaultValueFunctionPtr)(const JSObject*, ExecState*, PreferredPrimitiveType);
    ...
    typedef bool (*CustomHasInstanceFunctionPtr)(JSObject*, ExecState*, TiValue);

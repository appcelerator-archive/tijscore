...
namespace TI {
    ...
    JSObject* constructFunction(ExecState*, JSGlobalObject*, const ArgList&, const Identifier& functionName, const String& sourceURL, const WTI::TextPosition&);
    JSObject* constructFunction(ExecState*, JSGlobalObject*, const ArgList&);

    JS_EXPORT_PRIVATE JSObject* constructFunctionSkippingEvalEnabledCheck(ExecState*, JSGlobalObject*, const ArgList&, const Identifier&, const String&, const WTI::TextPosition&);

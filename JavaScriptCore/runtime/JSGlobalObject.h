...
private:
    ...
    typedef HashMap<OpaqueTiClass*, std::unique_ptr<OpaqueTiClassContextData>> OpaqueTiClassDataMap;
    ...
    struct JSGlobalObjectRareData {
        ...
        OpaqueTiClassDataMap opaqueTiClassData;
    };
...
public:
    ...
    void addFunction(ExecState*, const Identifier&, TiValue);
...
#undef DEFINE_ACCESSORS_FOR_SIMPLE_TYPE
    ...
    void resetPrototype(VM&, TiValue prototype);
    ...
    {
        createRareDataIfNeeded();
        return m_rareData->opaqueTiClassData;
    }
...
protected:
    ...
    JS_EXPORT_PRIVATE static TI::TiValue toThis(TI::JSCell*, TI::ExecState*, ECMAMode);
...
JSGlobalObject* asGlobalObject(TiValue);

inline JSGlobalObject* asGlobalObject(TiValue value)
{
...
inline JSArray* constructArray(ExecState* exec, ArrayAllocationProfile* profile, JSGlobalObject* globalObject, const TiValue* values, unsigned length)
{
...
inline JSArray* constructArray(ExecState* exec, ArrayAllocationProfile* profile, const TiValue* values, unsigned length)
{
    return constructArray(exec, profile, exec->lexicalGlobalObject(), values, length);
}

inline JSArray* constructArrayNegativeIndexed(ExecState* exec, ArrayAllocationProfile* profile, JSGlobalObject* globalObject, const TiValue* values, unsigned length)
{
...
inline JSArray* constructArrayNegativeIndexed(ExecState* exec, ArrayAllocationProfile* profile, const TiValue* values, unsigned length)
{

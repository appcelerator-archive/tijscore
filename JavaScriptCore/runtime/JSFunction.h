...
namespace TI {
    ...
    JS_EXPORT_PRIVATE EncodedTiValue JSC_HOST_CALL callHostFunctionAsConstructor(ExecState*);
    ...
    private:
        ...
        static EncodedTiValue callerGetter(ExecState*, EncodedTiValue, EncodedTiValue, PropertyName);
        static EncodedTiValue lengthGetter(ExecState*, EncodedTiValue, EncodedTiValue, PropertyName);
        static EncodedTiValue nameGetter(ExecState*, EncodedTiValue, EncodedTiValue, PropertyName);

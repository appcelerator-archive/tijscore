...
#define DECLARE_EXPORT_INFO                                             \
    protected:                                                          \
        static JS_EXPORTDATA const ::TI::ClassInfo s_info;             \
    public:                                                             \
        static const ::TI::ClassInfo* info() { return &s_info; }

#define DECLARE_INFO                                                    \
    protected:                                                          \
        static const ::TI::ClassInfo s_info;                           \
    public:                                                             \
        static const ::TI::ClassInfo* info() { return &s_info; }
...
public:
    ...
    // Basic conversions.
    JS_EXPORT_PRIVATE TiValue toPrimitive(ExecState*, PreferredPrimitiveType) const;
    ...
    static void putByIndex(JSCell*, ExecState*, unsigned propertyName, TiValue, bool shouldThrow);
    ...
    TiValue fastGetOwnProperty(ExecState*, const String&);
...
protected:
    ...
    JS_EXPORT_PRIVATE static bool customHasInstance(JSObject*, ExecState*, TiValue);
...
template<typename To>
inline To jsDynamicCast(TiValue from)
{

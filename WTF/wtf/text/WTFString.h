...
inline bool String::isAllSpecialCharacters() const
{
    ...
    if (is8Bit())
        return WTI::isAllSpecialCharacters<isSpecialCharacter, LChar>(characters8(), len);
    return WTI::isAllSpecialCharacters<isSpecialCharacter, UChar>(characters(), len);
}

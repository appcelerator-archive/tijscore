...
public:
    ...
    AtomicString(WTI::HashTableDeletedValueType) : m_string(WTI::HashTableDeletedValue) { }
...
inline bool operator==(const AtomicString& a, const char* b) { return WTI::equal(a.impl(), reinterpret_cast<const LChar*>(b)); }

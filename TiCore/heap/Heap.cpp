...
void Heap::getConservativeRegisterRoots(HashSet<TiCell*>& roots)
{
#ifndef NDEBUG
    ...
    TiCell** registerRoots = registerFileRoots.roots();
...
private:
    const char* typeName(TiCell*);
    OwnPtr<TypeCountSet> m_typeCountSet;
    HashSet<TiCell*> m_cells;
};
...
inline const char* TypeCounter::typeName(TiCell* cell)
{
    if (cell->isString())
        return "string";
...
inline void TypeCounter::operator()(TiCell* cell)
{

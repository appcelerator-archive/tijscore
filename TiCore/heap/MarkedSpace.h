...
namespace TI {
    ...
    public:
        ...
        static void setMarked(const TiCell*);

        MarkedSpace(TiGlobalData*);
        void destroy();
    ...
    inline Heap* MarkedSpace::heap(TiCell* cell)
    {
        return MarkedBlock::blockFor(cell)->heap();
    }

    inline bool MarkedSpace::isMarked(const TiCell* cell)
    {
        return MarkedBlock::blockFor(cell)->isMarked(cell);
    }

    inline bool MarkedSpace::testAndSetMarked(const TiCell* cell)
    {
        return MarkedBlock::blockFor(cell)->testAndSetMarked(cell);
    }

    inline void MarkedSpace::setMarked(const TiCell* cell)
    {
    ...
    inline TiGlobalData* MarkedSpace::globalData()
    {
        return m_globalData;
    }

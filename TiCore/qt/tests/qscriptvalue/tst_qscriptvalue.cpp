...
void tst_QScriptValue::setProperty()
{
    ...
    QEXPECT_FAIL("int + readOnly", "WebKit bug: 40613 (The TiObjectSetProperty doesn't overwrite property flags)", Continue);
    QEXPECT_FAIL("int + readOnly|undeletable", "WebKit bug: 40613 (The TiObjectSetProperty doesn't overwrite property flags)", Continue);
    QEXPECT_FAIL("int + skipInEnumeration|readOnly", "WebKit bug: 40613 (The TiObjectSetProperty doesn't overwrite property flags)", Continue);
    QEXPECT_FAIL("int + skipInEnumeration|readOnly|undeletable", "WebKit bug: 40613 (The TiObjectSetProperty doesn't overwrite property flags)", Continue);
    ...
    QEXPECT_FAIL("int + undeletable", "WebKit bug: 40613 (The TiObjectSetProperty doesn't overwrite property flags)", Continue);
    QEXPECT_FAIL("int + readOnly|undeletable", "WebKit bug: 40613 (The TiObjectSetProperty doesn't overwrite property flags)", Continue);
    QEXPECT_FAIL("int + skipInEnumeration|undeletable", "WebKit bug: 40613 (The TiObjectSetProperty doesn't overwrite property flags)", Continue);
    QEXPECT_FAIL("int + skipInEnumeration|readOnly|undeletable", "WebKit bug: 40613 (The TiObjectSetProperty doesn't overwrite property flags)", Continue);
    ...
    QEXPECT_FAIL("int + skipInEnumeration", "WebKit bug: 40613 (The TiObjectSetProperty doesn't overwrite property flags)", Continue);
    QEXPECT_FAIL("int + skipInEnumeration|undeletable", "WebKit bug: 40613 (The TiObjectSetProperty doesn't overwrite property flags)", Continue);
    QEXPECT_FAIL("int + skipInEnumeration|readOnly", "WebKit bug: 40613 (The TiObjectSetProperty doesn't overwrite property flags)", Continue);
    QEXPECT_FAIL("int + skipInEnumeration|readOnly|undeletable", "WebKit bug: 40613 (The TiObjectSetProperty doesn't overwrite property flags)", Continue);

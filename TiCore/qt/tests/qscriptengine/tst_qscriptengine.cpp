...
void tst_QScriptEngine::newFunction()
{
    QScriptEngine eng;
    {
        ...
        // a prototype property is automatically constructed
        {
            ...
            QEXPECT_FAIL("", "TiCallbackObject::getOwnPropertyDescriptor() doesn't return correct information yet", Continue);
            QCOMPARE(fun.propertyFlags("prototype"), QScriptValue::Undeletable);
            QEXPECT_FAIL("", "WebKit bug: 40613 (The TiObjectSetProperty doesn't overwrite property flags)", Continue);

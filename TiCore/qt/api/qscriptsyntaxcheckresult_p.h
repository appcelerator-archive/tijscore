...
public:
    ...
    inline QScriptSyntaxCheckResultPrivate(const QScriptEnginePrivate* engine, TiObjectRef value);
...
QScriptSyntaxCheckResultPrivate::QScriptSyntaxCheckResultPrivate(const QScriptEnginePrivate* engine, TiObjectRef value)
    : m_exception(value)
    , m_engine(const_cast<QScriptEnginePrivate*>(engine))
{}

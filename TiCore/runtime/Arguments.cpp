...
void Arguments::fillArgList(TiExcState* exec, MarkedArgumentBuffer& args)
{
    if (UNLIKELY(d->overrodeLength)) {
...
bool Arguments::getOwnPropertySlot(TiExcState* exec, unsigned i, PropertySlot& slot)
{
...
bool Arguments::deleteProperty(TiExcState* exec, unsigned i) 
{
    if (i < d->numArguments) {

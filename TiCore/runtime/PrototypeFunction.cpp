...
PrototypeFunction::PrototypeFunction(TiExcState* exec, int length, const Identifier& name, NativeFunction function)
...
PrototypeFunction::PrototypeFunction(TiExcState* exec, NonNullPassRefPtr<Structure> prototypeFunctionStructure, int length, const Identifier& name, NativeFunction function)

...
namespace TI {
    ...
    public:
        ...
        TiObject* const & operator*() const { return m_node->object; }
        TiObject* const * operator->() const { return &(operator*()); }
    ...
    public:
        ...
        ScopeChain(TiObject* o, TiGlobalData* globalData, TiGlobalObject* globalObject, TiObject* globalThis)

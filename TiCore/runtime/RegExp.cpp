...
PassRefPtr<RegExp> RegExp::create(TiGlobalData* globalData, const UString& pattern)
{
    return adoptRef(new RegExp(globalData, pattern));
}

PassRefPtr<RegExp> RegExp::create(TiGlobalData* globalData, const UString& pattern, const UString& flags)
{

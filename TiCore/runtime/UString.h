...
namespace TI {
    ...
    struct IdentifierRepHash : PtrHash<RefPtr<TI::UString::Rep> > {
        static unsigned hash(const RefPtr<TI::UString::Rep>& key) { return key->existingHash(); }
        static unsigned hash(TI::UString::Rep* key) { return key->existingHash(); }
    };
...
namespace WTI {
    ...
    template<> struct StrHash<TI::UString::Rep*> {
        ...
        static bool equal(const TI::UString::Rep* a, const TI::UString::Rep* b) { return ::equal(a, b); }
    ...
    template<> struct StrHash<RefPtr<TI::UString::Rep> > : public StrHash<TI::UString::Rep*> {
        ...
        static bool equal(const RefPtr<TI::UString::Rep>& a, const RefPtr<TI::UString::Rep>& b) { return ::equal(a.get(), b.get()); }
        static bool equal(const TI::UString::Rep* a, const RefPtr<TI::UString::Rep>& b) { return ::equal(a, b.get()); }
        static bool equal(const RefPtr<TI::UString::Rep>& a, const TI::UString::Rep* b) { return ::equal(a.get(), b); }

        static const bool safeToCompareToEmptyOrDeleted = false;
    };

    template <> struct VectorTraits<TI::UString> : SimpleClassVectorTraits
    {

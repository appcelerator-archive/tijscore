...
namespace TI {
    ...
    using WTI::PlacementNewAdoptType;
    using WTI::PlacementNewAdopt;
    ...
    struct IdentifierRepHash : PtrHash<RefPtr<TI::UString::Rep> > {
        static unsigned hash(const RefPtr<TI::UString::Rep>& key) { return key->computedHash(); }
        static unsigned hash(TI::UString::Rep* key) { return key->computedHash(); }
    };
...
namespace WTI {
    ...
    template<> struct StrHash<TI::UString::Rep*> {
        static unsigned hash(const TI::UString::Rep* key) { return key->hash(); }
        static bool equal(const TI::UString::Rep* a, const TI::UString::Rep* b) { return TI::equal(a, b); }
        static const bool safeToCompareToEmptyOrDeleted = false;
    };

    template<> struct StrHash<RefPtr<TI::UString::Rep> > : public StrHash<TI::UString::Rep*> {
        using StrHash<TI::UString::Rep*>::hash;
        static unsigned hash(const RefPtr<TI::UString::Rep>& key) { return key->hash(); }
        using StrHash<TI::UString::Rep*>::equal;
        static bool equal(const RefPtr<TI::UString::Rep>& a, const RefPtr<TI::UString::Rep>& b) { return TI::equal(a.get(), b.get()); }
        static bool equal(const TI::UString::Rep* a, const RefPtr<TI::UString::Rep>& b) { return TI::equal(a, b.get()); }
        static bool equal(const RefPtr<TI::UString::Rep>& a, const TI::UString::Rep* b) { return TI::equal(a.get(), b); }

        static const bool safeToCompareToEmptyOrDeleted = false;
    };

    template<> struct DefaultHash<TI::UString::Rep*> {
        typedef StrHash<TI::UString::Rep*> Hash;
    };

    template<> struct DefaultHash<RefPtr<TI::UString::Rep> > {
        typedef StrHash<RefPtr<TI::UString::Rep> > Hash;

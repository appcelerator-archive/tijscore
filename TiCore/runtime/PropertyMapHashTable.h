...
namespace TI {
    ...
    struct PropertyMapEntry {
        ...
        PropertyMapEntry(UString::Rep* key, unsigned attributes, TiCell* specificValue)
            : key(key)
            , offset(0)
        ...
        PropertyMapEntry(UString::Rep* key, unsigned offset, unsigned attributes, TiCell* specificValue, unsigned index)
            : key(key)
            , offset(offset)
            , attributes(attributes)
            , specificValue(specificValue)

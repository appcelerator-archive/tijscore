...
GlobalEvalFunction::GlobalEvalFunction(TiExcState* exec, NonNullPassRefPtr<Structure> structure, int len, const Identifier& name, NativeFunction function, TiGlobalObject* cachedGlobalObject)

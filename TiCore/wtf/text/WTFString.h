...
public:
    ...
    WTI::Unicode::Direction defaultWritingDirection(bool* hasStrongDirectionality = 0) const
    {
        if (m_impl)
            return m_impl->defaultWritingDirection(hasStrongDirectionality);
        if (hasStrongDirectionality)
            *hasStrongDirectionality = false;
        return WTI::Unicode::LeftToRight;
    }
    ...
    String(WTI::HashTableDeletedValueType) : m_impl(WTI::HashTableDeletedValue) { }
...
{
    return WTI::isAllSpecialCharacters<isSpecialCharacter>(characters(), length());
}
...
using WTI::CString;
using WTI::String;
using WTI::emptyString;
using WTI::append;
using WTI::appendNumber;
using WTI::charactersAreAllASCII;
using WTI::charactersAreAllLatin1;
using WTI::charactersToIntStrict;
using WTI::charactersToUIntStrict;
using WTI::charactersToInt64Strict;
using WTI::charactersToUInt64Strict;
using WTI::charactersToIntPtrStrict;
using WTI::charactersToInt;
using WTI::charactersToUInt;
using WTI::charactersToInt64;
using WTI::charactersToUInt64;
using WTI::charactersToIntPtr;
using WTI::charactersToDouble;
using WTI::charactersToFloat;
using WTI::equal;
using WTI::equalIgnoringCase;
using WTI::find;
using WTI::isAllSpecialCharacters;
using WTI::isSpaceOrNewline;
using WTI::reverseFind;

...
class StringImpl : public StringImplBase {
    friend struct TI::IdentifierCStringTranslator;
    friend struct TI::IdentifierUCharBufferTranslator;
    friend struct WTI::CStringTranslator;
    friend struct WTI::HashAndCharactersTranslator;
...
public:
    ...
    WTI::Unicode::Direction defaultWritingDirection(bool* hasStrongDirectionality = 0);
...
static inline bool isSpaceOrNewline(UChar c)
{
    ...
    return c <= 0x7F ? WTI::isASCIISpace(c) : WTI::Unicode::direction(c) == WTI::Unicode::WhiteSpaceNeutral;
}

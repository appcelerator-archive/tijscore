...
public:
    ...
    static unsigned computeHash(const UChar* data, unsigned length) { return WTI::stringHash(data, length); }
    static unsigned computeHash(const char* data, unsigned length) { return WTI::stringHash(data, length); }
    static unsigned computeHash(const char* data) { return WTI::stringHash(data); }
    ...
    WTI::Unicode::Direction defaultWritingDirection();

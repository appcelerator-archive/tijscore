...
namespace TI {
    ...
    public:
        ...
        PassRefPtr<ParsedNode> parse(TiGlobalObject* lexicalGlobalObject, Debugger*, TiExcState*, const SourceCode& source, FunctionParameters*, JSParserStrictness strictness, TiObject** exception);
    ...
    private:
        void parse(TiGlobalData*, FunctionParameters*, JSParserStrictness strictness, JSParserMode mode, int* errLine, UString* errMsg);
    ...
    template <class ParsedNode>
    PassRefPtr<ParsedNode> Parser::parse(TiGlobalObject* lexicalGlobalObject, Debugger* debugger, TiExcState* debuggerTiExcState, const SourceCode& source, FunctionParameters* parameters, JSParserStrictness strictness, TiObject** exception)
    {
        ...
        if (debugger && !ParsedNode::scopeIsFunction)
            debugger->sourceParsed(debuggerTiExcState, source.provider(), errLine, errMsg);
